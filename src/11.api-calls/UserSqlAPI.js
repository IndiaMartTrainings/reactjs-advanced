...
export class UserSqlAPI extends Component {
    constructor(){
        super()
    ...
    updateUser(){
        ...
        fetch(`http://localhost:3001/api/users/${this.state.id}`, putRequest)
        .then(response => response.json())
        .then(data => {
            this.getUsers()
            this.resetForm()
